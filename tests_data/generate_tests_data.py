...
tests_data_foler = Path("tests_data")
...
def gen_random_integer_array_tests():
    ...
    for pw in range(1, maxn + 1):
        ...
        with open(f"{tests_data_foler}/int/test_random_integer_array_{2**pw}.txt", "w") as w:
            for i in array:
                print(i, file = w)
...
def gen_random_small_integer_array_tests():
    ...
    for pw in range(1, maxn):
        ...
        with open(f"{tests_data_foler}/int/test_random_small_integer_array_{2**pw}.txt", "w") as w:
            for i in array:
                print(i, file = w)

if __name__ == "__main__":
    seed(179)
    tests_data_foler.mkdir(exist_ok = True)
